...
public class Runner implements CommandLineRunner {
    ...
    public void populateDatabase() {
        ...
        List<Reservation> reservationList = Arrays.asList(
                new Reservation(userList.get(1), officeList.get(1), date1, date1.plusDays(1), 4),
                new Reservation(userList.get(0), officeList.get(0), date1, date1.plusDays(1), 14),
                new Reservation(userList.get(2), officeList.get(2), date1, date1.plusDays(1), 7),
                new Reservation(userList.get(3), officeList.get(3), date1, date1.plusDays(1), 3),
                new Reservation(userList.get(4), officeList.get(4), date1, date1.plusDays(1), 19),
                new Reservation(userList.get(5), officeList.get(5), date1, date1.plusDays(1), 11),
                new Reservation(userList.get(6), officeList.get(6), date1, date1.plusDays(1), 2),
                new Reservation(userList.get(7), officeList.get(7), date1, date1.plusDays(1), 24),
                new Reservation(userList.get(8), officeList.get(8), date1, date1.plusDays(1), 5),
                new Reservation(userList.get(9), officeList.get(9), date1, date1.plusDays(1), 4),

                new Reservation(userList.get(0), officeList.get(10), date2, date2.plusDays(1), 17),
                new Reservation(userList.get(1), officeList.get(11), date2, date2.plusDays(1), 9),
                new Reservation(userList.get(2), officeList.get(12), date2, date2.plusDays(1), 3),
                new Reservation(userList.get(3), officeList.get(13), date2, date2.plusDays(1), 21),
                new Reservation(userList.get(4), officeList.get(14), date2, date2.plusDays(1), 8),
                new Reservation(userList.get(5), officeList.get(15), date2, date2.plusDays(1), 5),
                new Reservation(userList.get(6), officeList.get(16), date2, date2.plusDays(1), 16),
                new Reservation(userList.get(7), officeList.get(17), date2, date2.plusDays(1), 7),
                new Reservation(userList.get(8), officeList.get(18), date2, date2.plusDays(1), 5),
                new Reservation(userList.get(9), officeList.get(19), date2, date2.plusDays(1), 29),

                new Reservation(userList.get(0), officeList.get(20), date3, date3.plusDays(1), 6),
                new Reservation(userList.get(1), officeList.get(21), date3, date3.plusDays(1), 5),
                new Reservation(userList.get(2), officeList.get(22), date3, date3.plusDays(1), 19),
                new Reservation(userList.get(3), officeList.get(23), date3, date3.plusDays(1), 9),
                new Reservation(userList.get(4), officeList.get(24), date3, date3.plusDays(1), 2),
                new Reservation(userList.get(5), officeList.get(25), date3, date3.plusDays(1), 24),
                new Reservation(userList.get(6), officeList.get(26), date3, date3.plusDays(1), 8),
                new Reservation(userList.get(7), officeList.get(27), date3, date3.plusDays(1), 4),
                new Reservation(userList.get(8), officeList.get(28), date3, date3.plusDays(1), 17),
                new Reservation(userList.get(9), officeList.get(29), date3, date3.plusDays(1), 7)
        );
